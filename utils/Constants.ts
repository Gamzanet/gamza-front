export { sampleCodeTakeProfitHook };

const sampleCodeTakeProfitHook: string = `// SPDX-License-Identifier: UNLICENSED
...
contract TakeProfitsHook is BaseHook, ERC1155 {
    ...
    function redeem(
        ...
        // If no output tokens can be claimed yepositionIdt i.e. order hasn't been filled
        // throw error
        if (claimableOutputTokens[] == 0) revert NothingToClaim();
